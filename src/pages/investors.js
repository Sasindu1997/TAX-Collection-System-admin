...
import { CustomersTable } from 'src/sections/investors/customers-table';
import { CustomersSearch } from 'src/sections/investors/customers-search';
...
const Page = () => {
  ...
  useEffect(() => {
    ...
    setOpenBackDrop(true)
    cusId && SDK.InvestorType.getById(cusId)
    .then((res) => {
      console.log("RES: ", res);
  ...
  const handleDelete = () => {
    cusId && SDK.InvestorType.deletebyId(cusId)
    .then((res) => {
      console.log("RES: ", res);
      setOpenDelete(false);
  ...
  const handleSubmitUpdate = (values) => {
    ...
    cusId && SDK.InvestorType.updatePatch(cusId, obj)
    .then((res) => {
      console.log("RES: ", res);
      setOpenUpdate(false);
      setSnackSeverity('success');
